...
export const UI = {
    ...
    init() {
        ...
        this.el = {
            ...
            campaignAutopilotBtn: document.getElementById('campaignAutopilotBtn'),
            campaignServiceSelect: document.getElementById('campaignServiceSelect'),
            campaignCustomServiceContainer: document.getElementById('campaignCustomServiceContainer'),
            campaignCustomServiceInput: document.getElementById('campaignCustomServiceInput'),
            campaignToneSelect: document.getElementById('campaignToneSelect'),
            campaignMinWordsSelect: document.getElementById('campaignMinWordsSelect'),
            campaignLanguageSelect: document.getElementById('campaignLanguageSelect'),
